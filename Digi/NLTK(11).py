...
personality_patterns_list = [(personality_pattern, responses) for personality, (personality_pattern, responses) in personality_patterns.items()]


all_patterns = basic_patterns + mood_patterns_list + personality_patterns_list
...
def main():
    ...
    print("You can chat with me about anything, and I'll respond based on my personality,mood and style of human.\n")
    while True:
